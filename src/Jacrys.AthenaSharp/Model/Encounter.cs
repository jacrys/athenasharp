...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Encounter :  IEquatable<Encounter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Encounter" /> class.
        /// </summary>
        /// <param name="encounterid">Athena ID for this encounter (required).</param>
        ...
        public Encounter(int? encounterid = default(int?), List<PatientEncounterDiagnosis> diagnoses = default(List<PatientEncounterDiagnosis>), int? appointmentid = default(int?), int? departmentid = default(int?), string encountervisitname = default(string), string encountertype = default(string), string status = default(string), int? patientlocationid = default(int?), string patientlocation = default(string), int? patientstatusid = default(int?), string patientstatus = default(string), string encounterdate = default(string), string stage = default(string), int? providerid = default(int?), string providerfirstname = default(string), string providerlastname = default(string), string providerphone = default(string), string lastupdated = default(string))
        {
            ...
            if (diagnoses == null)
            {
                throw new InvalidDataException("diagnoses is a required property for Encounter and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Encounter);
        }

        /// <summary>
        /// Returns true if Encounter instances are equal
        /// </summary>
        /// <param name="input">Instance of Encounter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Encounter input)
        {
            if (input == null)
                return false;
